...
class OrderPage(BasePage):
    ORDER_UPPER_BUTTON = (By.XPATH, "//button [@class ='Button_Button_ra12g']")
    ORDER_MIDDLE_BUTTON = (By.XPATH, "//button [@class ='Button_Button_ra12g Button_Middle_1CSJM']")
    ...
    METRO_SOKOLNIKI = (By.XPATH, "//button[value = 'Сокольники']")
    METRO_LUBYANKA = (By.XPATH, "//button[value = 'Лубянка']")
    ...
    def choose_metro_set_phone_1(self):
        ...
        self.choose_metro(self.METRO_SOKOLNIKI)
    ...
    def choose_metro_set_phone_2(self):
        self.click_metro_field()
        self.choose_metro(self.METRO_LUBYANKA)
